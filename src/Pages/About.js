...
const About = () => {
        ...
        return (
            <div className="content-block">
                ...
                <h2>About</h2>
                <p>My name is <span className="text-highlight">Mill Mason</span>. I'm a developer and artist based in Brooklyn. I like to make things that add color and simplicity to life.</p>
