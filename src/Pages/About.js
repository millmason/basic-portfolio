...
const About = () => {
        ...
        return (
            <div className="content-block">
                ...
                <p>You can take a look at some of my projects <Link className="link" to="/projects">here</Link>, or check out what I've been up to on <a className="link" href="https://glitch.com/@househaunt">Glitch</a> or <a className="link" href="www.github.com/millsoper">Github</a>.</p>
            </div>
        )
    }
